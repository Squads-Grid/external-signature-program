...
mod tests {
    ...
    fn test_real_world_slot_scenarios() {
        ...
        let slots = vec![
            349_862_995, 349_862_996, 349_862_997, 349_862_998, 349_862_999,
            349_863_000, 349_863_001, 349_863_002, 349_863_003, 349_863_004,
        ];
        
        let truncated_slots: Vec<TruncatedSlot> = slots.iter()
        ...
        assert_eq!(truncated_slots[5].get_index_difference(&truncated_slots[4]).unwrap(), 1); // 0 - 999 = 1
        assert_eq!(truncated_slots[6].get_index_difference(&truncated_slots[4]).unwrap(), 2); // 1 - 999 = 2
        assert_eq!(truncated_slots[6].get_index_difference(&truncated_slots[5]).unwrap(), 1); // 1 - 0 = 1
    }
